package tooltwist.training_bonfranco.widgets;
...
import tooltwist.training_bonfranco.productionHelpers.HelloBonFrancoProductionHelper;
 ...
 * Hello Bon Franco!
 */
public class HelloBonFrancoWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "helloBonFranco_preview.html";
	private static final String SNIPPET_DESIGN = "helloBonFranco_design.html";
	private static final String SNIPPET_PRODUCTION = "helloBonFranco_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator,instance, "helloBonFranco_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator,instance, "helloBonFranco_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, HelloBonFrancoProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(HelloBonFrancoProductionHelper.class.getName()));
			}
		}
