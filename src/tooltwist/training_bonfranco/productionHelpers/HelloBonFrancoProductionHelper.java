package tooltwist.training_bonfranco.productionHelpers;
...
public class HelloBonFrancoProductionHelper extends WbdProductionHelper
{
	...
	public HelloBonFrancoProductionHelper(Properties prop)
	{
		super(prop);
	}
